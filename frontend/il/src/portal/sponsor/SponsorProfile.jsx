...
export default function SponsorProfile() {
  ...
  const [me, setMe] = useState({ name: "", email: "", organization: "", role: "" });
        ...
        <div className="min-h-screen w-full relative text-white/90">
          <div className="relative z-10">
            ...
            <div className="px-4 pt-4 pb-24 mx-auto max-w-4xl">
              <h1 className="text-3xl font-bold tracking-tight mb-6">Sponsor Profile</h1>
              ...
              {!loading && !error && (
                <GlassCard className="p-6 space-y-4">
                  ...
                  <Field label="Organization" value={me.organization} />
                </GlassCard>
              )}
            </div>
            <SponsorBottomNav />
